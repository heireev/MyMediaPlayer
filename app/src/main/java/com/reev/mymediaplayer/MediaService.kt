...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.reev.mymediaplayer.create"
        const val ACTION_DESTROY = "com.reev.mymediaplayer.destroy"
    ...
    private fun init() {
        ...
        val afd = applicationContext.resources.openRawResourceFd(R.raw.iphone_tone)
        try {
